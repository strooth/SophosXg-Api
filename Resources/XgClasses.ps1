...
Class XgGet
{
	...
	{
		$This.Get_Entity = [XgEntities]::$($Get_Entity).tolower()
		$This.Request = $This.Uri($This)
	}
	Build([Get_Build]$Build)
	{
		$This.Get_Entity = [XgEntities]::$($Build.Get_Entity).tolower()
		$This.Request = $This.Uri($This)
	}
	Build([XgGet]$Build)
 {
...
Class Api
{
	...
	url ([XgApicall]$type)
 {
	...
	{
		$This.url($This)
		$This.Response = Invoke-RestMethod -Uri ($This.Request.Uri.originalString)
		Return $This.Response
	}
	[String] Invoke ([Api]$Api)
	{
		$This.url($Api.Uri, $Api.Cred.Request, $This.$($This.Lasttype).Request)
		$This.Response = Invoke-RestMethod -Uri ($Api.Request.Uri.originalString)
		Return $This.Response
	}
}
Class Xg
{
	...
	Xg([pscustomObject]$Xg)
 {
	...
	invoke()
	{
		$This.Api.Response = Invoke-RestMethod -Uri (gss $This.Api.Request)
		$This.Api.Response
	}
	invoke($x)
	{
		Switch ($x.tolower())
		{
			filter
			{
				$This.Api.LastType = [XgApicall]::$($x).tolower()
